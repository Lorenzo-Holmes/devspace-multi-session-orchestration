...
chat_goal_create|goal-control|L|M|obk|K|chat-goals|chat|chat-goal.create|chat_goal_preflight|chat_goal_status|Persist finite frozen tasks for the current Chat model; no native/API/local model spawning.
