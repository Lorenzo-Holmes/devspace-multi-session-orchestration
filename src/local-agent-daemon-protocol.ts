...
import { goalRequestSchema, type GoalRequest } from "./goal-contracts.js";
...
export type LocalAgentDaemonRequest =
  ...
  | AgentDaemonRequestBase<"goal.request", GoalRequest>
...
export function decodeLocalAgentDaemonRequest(value: unknown): LocalAgentDaemonRequest {
  ...
  switch (method) {
    ...
    case "goal.request":
      return {requestId,protocolVersion,authToken,method,params:goalRequestSchema.parse(params)};
    case "daemon.logs":
      return {
        requestId,
        protocolVersion,
