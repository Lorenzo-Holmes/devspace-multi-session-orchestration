...
export type WorkspaceAccessMode = "read" | "modify";
...
export class SqliteWorkspaceStore implements WorkspaceStore {
  ...
  createSession(input: {
    ...
    const session: WorkspaceSession = {
      ...
      accessMode: input.accessMode ?? "modify",
...
function rowToWorkspaceSession(row: WorkspaceSessionRow): WorkspaceSession {
  return {
    ...
    accessMode: row.accessMode === "read" ? "read" : "modify",
    accessGrantId: row.accessGrantId ?? undefined,
