...
type SectionOverrides = {
  ...
  goals?: Partial<DevspaceConfig["goals"]>;
  chatGoals?: Partial<DevspaceConfig["chatGoals"]>;
  diagnostics?: Partial<DevspaceConfig["diagnostics"]>;
};
...
export function writeTestDevspaceConfig(
  ...
  writeDevspaceConfig({
    ...
    goals: { ...defaults.goals, ...overrides.goals },
    chatGoals: { ...defaults.chatGoals, ...overrides.chatGoals },
